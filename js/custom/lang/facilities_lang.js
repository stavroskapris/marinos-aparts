...
App.facilities_lang = {
    ...
    gr: {
        spaciousRooms: 'Ευρύχωρα δωμάτια',
        kitchen: 'Πλήρως εξοπλισμένη κουζίνα',
        fridge: 'Ψυγείο & κουζινάκι',
        parking: 'Ιδιωτικό parking με σκέπαστρο',
        airCondition: 'Αir-Condition',
        safe: 'Χρηματοκιβώτιο',
        yard: 'Μεγάλη αυλή',
        ...
        tableChairs: 'Τραπέζι και καρέκλες εξωτερικού χώρου',
        hairDryer: 'Σεσουάρ για τα μαλλιά',
        screens: 'Σίτες στα παράθυρα',
        wifi: 'Δωρεάν wi-fi Internet',
    },
};